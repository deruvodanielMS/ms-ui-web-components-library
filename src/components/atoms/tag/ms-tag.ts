...
import { msTagStyles } from './ms-tag.styles'
 ...
 *
 * @summary This is a simple MS tag component
 *
 * @tag ms-tag
 */
@customElement('ms-tag')
export class MsTag extends WithTheme(LitElement) {
  static styles = msTagStyles
